        ...
        <Popover.Root>
            ...
            <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                ...
                <div className='mt-6 flex flex-col gap-3'>
                    ...
                    >
                        <div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zing-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500'>
                            <Checkbox.Indicator>
